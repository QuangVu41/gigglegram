            ...
            {characters.map((char, i) => (
              ...
              >
                ...
                <motion.span
                  ...
                  className="inline-block font-bold antialiased font-dancing-script text-tertiary leading-none dark:text-tertiary"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
                ...
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-0 z-10 inline-block font-bold antialiased font-dancing-script text-indigo-600 leading-none dark:text-emerald-400"
                ...
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-0 z-10 inline-block font-bold antialiased font-dancing-script text-zinc-800 leading-none dark:text-zinc-200"
                  style={{
