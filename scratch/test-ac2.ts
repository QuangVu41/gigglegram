...
const owner = ac.newRole({
  ...
  setting: statements.setting as unknown as [
    (typeof statements.setting)[number],
  ],
  story: statements.story as unknown as [(typeof statements.story)[number]],
  highlight: statements.highlight as unknown as [
    (typeof statements.highlight)[number],
  ],
  collection: statements.collection as unknown as [
    (typeof statements.collection)[number],
  ],
